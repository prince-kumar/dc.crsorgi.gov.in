...
//  var Service_Url = 'https://devtran.census.gov.in/CDAC-EnhanceTransliterationAPI/'  //Main server Service_Url (ONLY CHANGE THIS IF NEEDED)
//  var Service_Url_Arr = ["https://devtran.census.gov.in/CDAC-EnhanceTransliterationAPI/", "https://devtran.census.gov.in/CDAC-EnhanceTransliterationAPI/"]; 
   
  var Service_Url = 'https://tran.census.gov.in/CDAC-EnhanceTransliterationAPI/'  //Main server Service_Url (ONLY CHANGE THIS IF NEEDED)
  var Service_Url_Arr = ["https://tran.census.gov.in/CDAC-EnhanceTransliterationAPI/", "https://tran.census.gov.in/CDAC-EnhanceTransliterationAPI/"]; 
 ...
 // Function to get cookie value by name
    ...
    // Example of getting the 'token' cookie
 //   const token = getCookie('token');
    const token = getCookie('token');
//    console.log(token);
 //   var token=localStorage.getItem('token');
    var jsFolderPath = Service_Url + 'js';
 // var jsFolderPath = './Packages/transliteration/js';
 ...
 // document.write("<link href='./js/css/CDAC-Typing-Script-Style.min.css' rel='stylesheet' type='text/css' />");
  ...
  //  var supportedLangCode1 = new Array("hin", "mar", "guj", "ben", "pan", "mal", "tam", "tel", "kan", "ori", "urd","asm","kok","mni");
//  var supportedLangCode2 = new Array("hi_in", "mr_in", "gj_in", "bn_in", "pn_in", "ml_in", "tm_in", "tl_in", "kn_in", "or_in", "ur_in","as_in", "ko_in","mn_in");
//  var supportedLangCode3 = new Array("hindi", "marathi", "gujarati", "bengali", "punjabi", "malayalam", "tamil", "telugu", "kannada", "oriya", "urdu", "assamese","konkani","manipuri");
  
  
  
  var supportedLangCode1 = new Array("hin", "mar", "guj", "ben", "pan", "mal", "tam", "tel", "kan", "ori", "urd","asm","kok","mni","nep","mai","dog","bod","san","sin","kas","sak");
  var supportedLangCode2 = new Array("hi_in", "mr_in", "gj_in", "bn_in", "pn_in", "ml_in", "tm_in", "tl_in", "kn_in", "or_in", "ur_in","as_in", "ko_in","mn_in","ni_in","mi.tr_in","di_in","bo_in","st.ol_in","sd.pa_in","ks.pa_in","sk_in");
  var supportedLangCode3 = new Array("hindi", "marathi", "gujarati", "bengali", "punjabi", "malayalam", "tamil", "telugu", "kannada", "oriya", "urdu", "assamese","konkani","manipuri", "nepali", "maithali","dogri","Bodo","santhali","sindhi","kashmiri","sanskrit");
  ...
  function executeAfterClickOnTextBox(controlIds) {
      ...
      try {//To make all variables generic type so they will work on each and every textbox on the page
          ...
          if (document.getElementById("popupBox_" + controlIds) == null) {
              ...
              var popupImageBx = $("<div id='imageDiv_Id' class='Gist_Typing_Popup_CdacImgDiv'><img src='./js/images/CDAC-GIST.bmp' alt='CDAC Gist' class='Gist_Typing_Popup_CdacImg'/></div>");
      ...
      try {
          ...
          if (englishTextArray.length > 1 && transTextArray.length > 1 && (englishTextArray.length == transTextArray.length)) {
            ...
            if (cacheFlag)
                ...
                trText = transResult;
            var delimiterIndex = trText.indexOf("^");
            var firstSuggestion = (delimiterIndex === -1) ? trText : trText.substring(0, delimiterIndex);
            resultToAppend += firstSuggestion + " ";
